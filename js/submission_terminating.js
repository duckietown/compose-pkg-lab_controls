...
function process_bags(next_function) {
  ...
  ajax_list["process_bags"] = $.ajax({
    ...
    data: JSON.stringify({"start_timestamp": start_timestamp, device_list: agent_list, "input_bag_name": logging_bag_name, "output_bag_name": "processed", "mount_computer_side": logging_bag_mount + "/logs_raw", "mount_container_side": "/data" }),
    dataType: "json",
    type: "POST",
    contentType: 'application/json',
    header: {},
